...
<html>
<head>
    <title>Edit Course Material - Online Course Management System</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="header">
                <div class="page-title">Edit Course Material</div>
                <a href="/admin/materials" class="back-link">Return to Materials List</a>
            </div>
            
            <div class="form-container">
                <form:form method="POST" modelAttribute="materialForm">
                    <div class="form-group">
                        <form:label path="courseId">Course ID</form:label>
                        <form:input path="courseId" type="number" readonly="true" />
                        <div class="file-info">Note: Course ID cannot be modified</div>
                    </div>
